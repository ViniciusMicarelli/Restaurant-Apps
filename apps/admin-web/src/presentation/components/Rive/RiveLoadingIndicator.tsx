 ...
 * Flutter (`assets/animations/liquid_download.riv`, ver README ao lado do
 * arquivo pra fonte/licença). Usa o componente simples `<Rive>` (sem
 * data-binding) — só autoplay do estado padrão do artboard.
 */
