"""Fixtures dos testes de integração do `kitchen-service` (SQLite + EventBus/Broadcaster em memória)."""
...
@pytest.fixture
def client(
    sqlite_session_factory: async_sessionmaker[AsyncSession], broadcaster: FakeBroadcaster
    ...
    app.dependency_overrides[deps.get_broadcaster] = lambda: broadcaster
